  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-surface">
      <header className="border-b border-border/60 bg-background/60 backdrop-blur">
        <div className="mx-auto flex max-w-2xl items-center gap-2 px-5 py-4">
          <Button asChild variant="ghost" size="sm">
            <Link to="/messages"><ArrowLeft className="mr-1 h-4 w-4" />Threads</Link>
          </Button>
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col px-5 py-6">
        ...
        <form onSubmit={handleSend} className="sticky bottom-4 flex items-end gap-2 rounded-2xl border border-border bg-card p-2 shadow-card">
          <Textarea
            value={body}
