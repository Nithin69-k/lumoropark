    ...
    >
      ...
      <LegalSection heading="5. Retention">
        <p>
          ...
          which data is deleted or anonymised. Closing your account removes your profile from the marketplace.
        </p>
      </LegalSection>
      ...
      <LegalSection heading="6. Your rights">
        <p>
          ...
          consent. You also have the right to complain to your local data protection authority. We aim to
      ...
      <LegalSection heading="7. Security">
        <p>
          ...
          access. No system can be guaranteed completely secure, so please use a strong, unique password.
        </p>
      </LegalSection>
      ...
      <LegalSection heading="8. Cookies">
        <p>
          ...
          cookies in your browser, but essential cookies are required for sign-in to work.
        </p>
      </LegalSection>
