...
export const Route = createFileRoute("/reset-password")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Choose a new password for your LumoroX Park account and get back to booking parking.",
      },
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-card">
          ...
          {!ready ? (
            ...
            <div className="mt-3 space-y-4 text-sm text-muted-foreground">
              <p>
                This reset link is invalid or has expired. Request a fresh one and it will arrive in a
                minute or two.
              </p>
