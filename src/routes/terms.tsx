  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Terms of Service | LUMORO X PARK" },
      {
        ...
        content: "Host and Driver obligations, platform liability, payments and account termination.",
      },
    ...
    >
      <LegalSection heading="1. Who you are contracting with">
        ...
        <p>
          ...
          of legal age to enter a contract.
        </p>
      </LegalSection>
      ...
      <LegalSection heading="4. Acceptable use">
        ...
        <p>
          ...
          account, and for providing accurate information and keeping it up to date.
        </p>
      </LegalSection>
      ...
      <LegalSection heading="5. Intellectual property">
        <p>
          ...
          upload (such as listing photos) solely to operate the service.
        </p>
      </LegalSection>
      ...
      <LegalSection heading="6. Payments, fees and subscriptions">
        ...
        <p>
          ...
          . Host Pro subscriptions renew automatically at the selected interval until cancelled. Platform
          commission and any reservation fee are shown before you confirm a purchase.
        </p>
      </LegalSection>

      <LegalSection heading="7. Service level and warranties">
        <p>
          The service is provided on an "as available" basis. We do not guarantee uninterrupted or error-free
          performance. To the fullest extent permitted by law, we disclaim all implied warranties, including
      ...
      <LegalSection heading="8. Liability">
        <p>
          To the fullest extent permitted by law, our aggregate liability is capped at the fees you paid to us
          in the twelve months preceding the claim. We exclude liability for indirect, consequential, or special
          damages, including loss of profits, data, or goodwill. Nothing in these terms excludes liability for
          fraud, death, or personal injury where such exclusion is prohibited by law. You indemnify us against
          claims arising from your content, unlawful use of the service, or breach of these terms.
        </p>
      </LegalSection>

      <LegalSection heading="9. Suspension and termination">
        <p>
          We may suspend or terminate access to the service for material breach of these terms, non-payment,
          security or fraud risk, or repeated or serious policy violations. You may close your account at any
          time. On termination, outstanding bookings are settled or refunded according to the Refund &amp;
          Cancellation Policy, and your data is handled as described in the Privacy Policy.
        </p>
      </LegalSection>
