            ...
            <article key={t.id} className="rounded-2xl border border-border bg-card p-5">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    {t.name} ·{" "}
                    <a href={`mailto:${t.email}`} className="inline-flex items-center gap-1 text-primary hover:underline">
              ...
              <div className="mt-4 space-y-2">
                ...
                <Button
                  ...
                  onClick={() =>
                    save.mutate({ id: t.id, status: t.status, note: notes[t.id] ?? t.admin_notes ?? "" })
                  }
                >
                  Save reply
                </Button>
