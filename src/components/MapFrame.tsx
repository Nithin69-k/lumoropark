...
export function MapSkeleton({ height, label = "Loading map…" }: { height: number; label?: string }) {
  return (
    <div
    ...
    >
      ...
      />
      <div aria-hidden className="absolute inset-0 animate-pulse bg-gradient-to-br from-transparent via-background/40 to-transparent" />
...
class MapErrorBoundary extends Component<BoundaryProps, BoundaryState> {
  ...
  componentDidCatch(error: Error) {
    ...
    reportLovableError(error, { boundary: "map" });
