        ...
        <form onSubmit={handleSubmit} className="space-y-8 rounded-3xl border border-border bg-card p-6 shadow-card md:p-8">
          <section className="space-y-4">
            ...
            <div>
              ...
              <Input id="title" value={title} onChange={(e) => setTitle(e.target.value)} placeholder="Covered driveway near downtown" />
            </div>
            <div>
              <Label htmlFor="desc">Description</Label>
              <Textarea id="desc" value={description} onChange={(e) => setDescription(e.target.value)} rows={3} placeholder="What renters should know…" />
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div>
              ...
              <Input id="addr" value={address} onChange={(e) => setAddress(e.target.value)} placeholder="123 Main St, Brooklyn NY" />
            </div>
            <div>
          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input id="ph" type="number" min="0" step="0.5" value={pricePerHour} onChange={(e) => setPricePerHour(e.target.value)} />
              </div>
              <div>
          ...
          <section className="space-y-4">
            <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">Vehicles allowed</h2>
          ...
          <section className="space-y-3">
            ...
            <div className="grid grid-cols-3 gap-3">
              {photos.map((p) => (
                <div key={p} className="relative aspect-square overflow-hidden rounded-lg border border-border">
...
function FeatureCheck({ label, checked, onChange }: { label: string; checked: boolean; onChange: (v: boolean) => void }) {
  return (
