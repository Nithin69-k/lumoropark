            ...
            {items.map((t) => (
              <li key={t.booking_id}>
                ...
                >
                  ...
                  <div className="mt-0.5 truncate text-xs text-muted-foreground">{t.space_title}</div>
                  {t.last_message && (
                    <p className="mt-2 line-clamp-1 text-sm text-muted-foreground">{t.last_message}</p>
                  )}
                </Link>
              </li>
            ))}
